...
The overall accuracy is `r round(100*unname(res1$overall['Accuracy']), digits = 2)`%. Table \@ref(tab:{{id}}-accuracybylu1) shows several accuracy measures for each of the land uses separately. The user's accuracy (sensititvity) and producer's accuracy (specificity) is also shown in Figure \@ref(fig:{{id}}-userproducer).
