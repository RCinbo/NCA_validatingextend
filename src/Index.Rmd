...
#   mutate(x = punten[, 'POINT_X'],
#          y = punten[, 'POINT_X']) %>%
#   rename(landgebruik = lu_landgebruik_vlaa_2016_v2) %>%
#   mutate(landgebruik = as.character(landgebruik)) 
# test$landgebruikrecode <- recode(test$landgebruik, 
#                                  "1" = "Urbaan",
#                                  "2" = "Urbaan",
#                                  "3" = "Urbaan",
#                                  "4" = "Urbaan",
...
#                                  "18" = "Laag groen")
# test <- test %>% 
#   replace_na(list(landgebruikrecode = "Overig")) %>%
#   mutate(code = 
#            factor(landgebruikrecode,
#                   levels = c("Open natuur", "Bos", "Grasland","Akker", "Urbaan", 
#                              "Laag groen", "Hoog groen", "Water", "Overig")),
#          landgebruikcode = as.factor(as.numeric(landgebruikrecode))
#          )
...
```{r results='asis', fig.path='figure/childall-'}
title <- "the original land use maps, updated with BAK"
